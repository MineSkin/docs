...
This means instead of making a request and receiving back the skin data after a few seconds, you will now receive the ID of a [queued job](/docs/mineskin-api/queue-skin-generation) which you can periodically [check the status](http://localhost:3000/docs/mineskin-api/get-job-status) of.
