...
Additionally, there is now a credits system which allows you to generate skins faster.
You are automatically granted 100 free credits per month with an additional 10 credits per day.
Each new skin generation uses up 1 credit.
